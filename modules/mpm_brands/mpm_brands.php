...
class mpm_brands extends Module{
  ...
  public function install()
  {
    if (!parent::install()
      ...
      || !Configuration::updateValue('GOMAKOIL_MANUFACTURER_BLOCK_TITLE', 1)
      || !Configuration::updateValue('GOMAKOIL_MANUFACTURER_HOME', 1)
      || !Configuration::updateValue('GOMAKOIL_MANUFACTURER_HOME_HOOK', 'displayHomeContent4')
      || !Configuration::updateValue('GOMAKOIL_MANUFACTURER_HOME_TITLE', 0)
  ...
  public function getContent()
  {
    ...
    if (Tools::isSubmit('submitManufacturersHomePage'))
    {
      ...
      $title =  Tools::getValue('GOMAKOIL_MANUFACTURER_BLOCK_TITLE');

      if (!Validate::isInt($count_left)){
        $errors = $this->l('Invalid number of elements.');
      }
      else {
        Configuration::updateValue('GOMAKOIL_MANUFACTURER_BLOCK_TITLE', $title);
    ...
    $fields_form = array(
      'form' => array(
        ...
        'input' => array(
          ...
          array(
            'type' => 'switch',
            'label' => $this->l('Show title in brands block'),
            'name' => 'GOMAKOIL_MANUFACTURER_BLOCK_TITLE',
            'values' => array(
              array(
                'id' => 'active_on',
                'value' => 1,
  ...
  {
    return array(
      'GOMAKOIL_MANUFACTURER_BLOCK_TITLE'       => Tools::getValue('GOMAKOIL_MANUFACTURER_BLOCK_TITLE', Configuration::get('GOMAKOIL_MANUFACTURER_BLOCK_TITLE')),
  ...
  public function getVariables()
  {
    ...
    $title_block = Configuration::get('GOMAKOIL_MANUFACTURER_BLOCK_TITLE');
