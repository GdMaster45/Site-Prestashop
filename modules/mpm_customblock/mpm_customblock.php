...
class mpm_customblock extends Module
{
  ...
  public function install()
  {
    if (!parent::install()
      ...
      || !Configuration::updateValue('GOMAKOIL_CUSTOM_BLOCK_HOOK', 'displayHomeContent1')
    )
      return false;
  ...
  private function _setDataDb(){
    ...
    $data = array(
      array('title' => 'Free Shipping'),
      array('title' => 'Money Back 100%'),
      array('title' => 'Support 24/7'),
      array('title' => 'Member Discount'),
    );
