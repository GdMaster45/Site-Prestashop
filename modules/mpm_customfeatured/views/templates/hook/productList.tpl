<div >
    {if $items}
        <table class="table_product_list_home">
            <thead>
                <tr>
                    <th class="table_id">{l s='ID' mod='mpm_customfeatured'}</th>
                    <th class="table_img">{l s='Image' mod='mpm_customfeatured'}</th>
                    <th class="table_name">{l s='Name' mod='mpm_customfeatured'}</th>
                    <th class="table_delete">{l s='Delete' mod='mpm_customfeatured'}</th>
                </tr>
            </thead>
            <tbody>
    ...
    {else}
        <div class="alert alert-warning">{l s='You have not added any product' mod='mpm_customfeatured'}</div>
    {/if}
</div>