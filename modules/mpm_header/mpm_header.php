...
class Mpm_header extends Module
{
  ...
  public function install()
  {
    ...
    $module_instance = Module::getInstanceByName('ps_emailsubscription');
    Hook::unregisterHook($module_instance, 'displayFooterBefore');

    $module_instance = Module::getInstanceByName('ps_emailsubscription');
    Hook::registerHook($module_instance, 'displayFooterAfter');
  ...
  {
    $this->context->controller->registerStylesheet('product_list', 'modules/mpm_header/views/css/product-list.css', array('media' => 'all', 'priority' => 900));
    ...
    $this->context->controller->registerStylesheet('quickview', 'modules/mpm_header/views/css/quickview.css', array('media' => 'all', 'priority' => 900));
    $this->context->controller->registerStylesheet('cart', 'modules/mpm_header/views/css/cart.css', array('media' => 'all', 'priority' => 900));
