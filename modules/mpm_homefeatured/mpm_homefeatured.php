...
class mpm_homefeatured extends Module
{
    ...
    {
        $data = [
            ['type' => 'all', 'hook' => 'displayHomeContent2', 'title' => 'Featured Products'],
//            ['type' => 'all', 'hook' => 'displayHomeContent3', 'title' => 'Our offers'],
            ['type' => 'new', 'hook' => 'displayHomeContent4', 'title' => 'New products'],
        ];
