...
class mpm_suppliers extends Module{
  ...
  public function install()
  {
    if (!parent::install()
      ...
      || !Configuration::updateValue('GOMAKOIL_SUPPLIER_BLOCK_TITLE', 1)
      ...
      || !Configuration::updateValue('GOMAKOIL_SUPPLIER_HOME_TITLE', 0)
  ...
  public function uninstall(){
    ...
    if ( !parent::uninstall()
      ...
      || !Configuration::deleteByName('GOMAKOIL_SUPPLIER_BLOCK_TITLE')
    )
      return false;
  ...
  public function getContent()
  {
    ...
    if (Tools::isSubmit('submitSuppliersHomePage'))
    {
      ...
      $title =  Tools::getValue('GOMAKOIL_SUPPLIER_BLOCK_TITLE');
      ...
      if (!Validate::isInt($count_left)){
        ...
        Configuration::updateValue('GOMAKOIL_SUPPLIER_BLOCK_TITLE', $title);
      }
    ...
    $fields_form = array(
      'form' => array(
        ...
        'input' => array(
          ...
          array(
            'type' => 'switch',
            'label' => $this->l('Show title in suppliers block'),
            'name' => 'GOMAKOIL_SUPPLIER_BLOCK_TITLE',
            'values' => array(
              array(
                'id' => 'active_on',
                'value' => 1,
  ...
  public function getConfigFieldsValues()
  {
    return array(
      ...
      'GOMAKOIL_SUPPLIER_BLOCK_TITLE' => Tools::getValue('GOMAKOIL_SUPPLIER_BLOCK_TITLE', Configuration::get('GOMAKOIL_SUPPLIER_BLOCK_TITLE')),
    );
  }
  ...
  {
    $title_block = Configuration::get('GOMAKOIL_SUPPLIER_BLOCK_TITLE');
