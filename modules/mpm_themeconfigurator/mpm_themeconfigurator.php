...
class mpm_themeconfigurator extends Module
{
  ...
  public function install()
  {
    ...
    if (!parent::install()
      ...
      || !Configuration::updateValue('THEME_BACKGROUND_COLOR', '#f69b0d')
      || !Configuration::updateValue('THEME_BACKGROUND_PAGE', '#ffffff')
      || !Configuration::updateValue('BACKGROUND_COLOR_FOOTER', '#dadada')
      || !Configuration::updateValue('COLOR_FOOTER', '#000000')
      || !Configuration::updateValue('COLOR_HOVER_FOOTER', '#f69b0d')
    ...
    $fields_form = array(
      'form' => array(
        ...
        'input' => array(
          ...
          array(
            'type' => 'color',
            'label' =>  $this->l('Background page'),
            'name' => 'THEME_BACKGROUND_PAGE',
            'desc' => $this->l('Default: #ffffff'),
          ),
          array(
            'type' => 'color',
            'label' =>  $this->l('Background color footer'),
          ...
          array(
            'type' => 'color',
            'label' =>  $this->l('Color text in footer'),
            'name' => 'COLOR_FOOTER',
            'desc' => $this->l('Default: #ffffff'),
          ),
          array(
  ...
  public function hookDisplayHeader($params)
  {
      ...
      if (Configuration::get('THEME_BACKGROUND_COLOR') == '#f69b0d' && Configuration::get('THEME_BACKGROUND_PAGE') == '#ffffff')
      {
        return false;
      }

    if (Configuration::get('THEME_BACKGROUND_COLOR') != '' ){
