...
class appAppKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'PrestaShopBundle\\Controller\\Admin\\SecuredFileReaderController' => 'getSecuredFileReaderControllerService.php',
    ...
    {
        return $this->services['PrestaShop\\PrestaShop\\Adapter\\Category\\Repository\\CategoryRepository'] = new \PrestaShop\PrestaShop\Adapter\Category\Repository\CategoryRepository(($this->services['doctrine.dbal.default_connection'] ?? $this->getDoctrine_Dbal_DefaultConnectionService()), 'psdh_');
    }
     ...
     */
    protected function getMultistoreFeatureService()
    {
    ...
    {
        return $this->services['PrestaShop\\PrestaShop\\Adapter\\Manufacturer\\Repository\\ManufacturerRepository'] = new \PrestaShop\PrestaShop\Adapter\Manufacturer\Repository\ManufacturerRepository();
    }
     ...
     */
    protected function getTaxRulesGroupRepositoryService()
    {
     ...
     */
    protected function getTaxRulesGroupValidatorService()
    {
        return $this->services['PrestaShop\\PrestaShop\\Adapter\\TaxRulesGroup\\Validate\\TaxRulesGroupValidator'] = new \PrestaShop\PrestaShop\Adapter\TaxRulesGroup\Validate\TaxRulesGroupValidator();
    }
     ...
     */
    protected function getColorBrightnessCalculatorService()
    {
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6HjNzeiKyu', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Pb3GC5wOmT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'sql202.byetcluster.com', 'port' => '', 'dbname' => 'if0_36915431_423', 'user' => '36915431_1', 'password' => '9pSA362.(W', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/PrestaShopBundle/Entity')]), 'PrestaShopBundle\\Entity');
        ...
        $a->setNamingStrategy(($this->services['prestashop.database.naming_strategy'] ?? ($this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('psdh_'))));
    ...
    protected function getHttpKernelService()
    {
        ...
        return $this->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver(new \Symfony\Bundle\FrameworkBundle\Controller\ControllerResolver($this, ($this->privates['monolog.logger.request'] ?? $this->getMonolog_Logger_RequestService()), ($this->privates['.legacy_controller_name_converter'] ?? ($this->privates['.legacy_controller_name_converter'] = new \Symfony\Bundle\FrameworkBundle\Controller\ControllerNameParser(($this->services['kernel'] ?? $this->get('kernel', 1)), false)))), $a), ($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($this->privates['argument_metadata_factory'] ?? ($this->privates['argument_metadata_factory'] = new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory())), new RewindableGenerator(function () {
            ...
            yield 5 => ($this->privates['debug.sensio_framework_extra.psr7.argument_value_resolver.server_request'] ?? $this->load('getDebug_SensioFrameworkExtra_Psr7_ArgumentValueResolver_ServerRequestService.php'));
            yield 6 => ($this->privates['debug.api_platform.argument_resolver.payload'] ?? $this->load('getDebug_ApiPlatform_ArgumentResolver_PayloadService.php'));
            yield 7 => ($this->privates['debug.argument_resolver.service'] ?? $this->load('getDebug_ArgumentResolver_ServiceService.php'));
            yield 8 => ($this->privates['debug.argument_resolver.default'] ?? $this->load('getDebug_ArgumentResolver_DefaultService.php'));
            yield 9 => ($this->privates['debug.argument_resolver.variadic'] ?? $this->load('getDebug_ArgumentResolver_VariadicService.php'));
            yield 10 => ($this->privates['debug.argument_resolver.not_tagged_controller'] ?? $this->load('getDebug_ArgumentResolver_NotTaggedControllerService.php'));
        }, 11)), $a));
    }
    ...
    /**
     * Gets the public 'prestashop.bundle.twig.extension.color_brightness_calculator_extension' shared autowired service.
     *
    ...
    /**
     * Gets the public 'prestashop.bundle.twig.extension.documentation_link_provider_extension' shared autowired service.
     *
    ...
    protected function getPrestashop_Core_Admin_MultistoreService()
    {
        ...
        $instance->multistoreFeature = ($this->services['PrestaShop\\PrestaShop\\Adapter\\Feature\\MultistoreFeature'] ?? $this->getMultistoreFeatureService());
        ...
        $instance->productRepository = ($this->services['PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository'] ?? $this->getProductRepositoryService());
    ...
    {
        return $this->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy('psdh_');
    }
    ...
    protected function getPrestashop_Hook_DispatcherService()
    {
        ...
        }, 3), ($this->services['prestashop.hooks_registry'] ?? ($this->services['prestashop.hooks_registry'] = new \PrestaShopBundle\DataCollector\HookRegistry())), ($this->services['prestashop.adapter.environment'] ?? ($this->services['prestashop.adapter.environment'] = new \PrestaShop\PrestaShop\Adapter\Environment(true)))->isDebug());
    }
    ...
    {
        return $this->services['prestashop.twig.extension.layout'] = new \PrestaShopBundle\Twig\LayoutExtension(($this->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? $this->getLegacyContextService()), 'dev', ($this->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ?? ($this->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] = new \PrestaShop\PrestaShop\Adapter\Configuration())), ($this->services['PrestaShop\\PrestaShop\\Adapter\\Currency\\CurrencyDataProvider'] ?? $this->getCurrencyDataProviderService()));
    }

    /**
     * Gets the public 'prestashop.twig.extension.multistore_components_extension' shared service.
     *
     * @return \PrestaShopBundle\Twig\Extension\MultistoreComponentsExtension
     */
    protected function getPrestashop_Twig_Extension_MultistoreComponentsExtensionService()
    {
        return $this->services['prestashop.twig.extension.multistore_components_extension'] = new \PrestaShopBundle\Twig\Extension\MultistoreComponentsExtension(($this->services['prestashop.core.admin.multistore'] ?? $this->getPrestashop_Core_Admin_MultistoreService()));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.1.6', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), [])));
        ...
        $instance->addExtension(($this->services['prestashop.twig.extension.multistore_components_extension'] ?? $this->getPrestashop_Twig_Extension_MultistoreComponentsExtensionService()));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZN64tjX23s', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0+skBinymc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dHeasyW8WE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TwmDrnWZrz', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6YhujdggTr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4Bx3Lu9qQM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9+NVJ10Z2i', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NEwV4EjNR3', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SkyrCeqBPB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('jmo6hxttjfefbjeqocjal9ddxxu9grd9ufylerbha10zigajiila1c0wm543kyjz'))), '/_fragment');
    }
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\RotatingFileHandler($this->getEnv('PS_LOG_OUTPUT'), $this->getEnv('PS_LOG_MAX_FILES'), 100, true, NULL, false);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            yield 'security.firewall.map.context.api' => ($this->privates['.security.request_matcher.RydbE6Y'] ?? ($this->privates['.security.request_matcher.RydbE6Y'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/new-api')));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                58 => 'mpm_contactform',
                59 => 'mpm_customblock',
                60 => 'mpm_customfeatured',
                61 => 'mpm_documentation',
                62 => 'mpm_footer',
                63 => 'mpm_header',
                64 => 'mpm_homeblocks',
                65 => 'mpm_homefeatured',
                ...
                68 => 'mpm_imageslist',
                69 => 'mpm_scrolltop',
                70 => 'mpm_social_buttons',
                71 => 'mpm_socialsharebuttons',
                72 => 'mpm_subcategories',
                73 => 'mpm_suppliers',
                74 => 'mpm_testimonials',
                75 => 'mpm_themeconfigurator',
                76 => 'mpm_topmenu',
                77 => 'mpm_viewproductlist',
                78 => 'mpm_solutions',
            ],
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => 'sql202.byetcluster.com',
            'database_port' => '',
            'database_name' => 'if0_36915431_423',
            'database_user' => '36915431_1',
            'database_password' => '9pSA362.(W',
            'database_prefix' => 'psdh_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'jmo6hxttjfefbjeqocjal9ddxxu9grd9ufylerbha10zigajiila1c0wm543kyjz',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-07-16',
            'locale' => 'en-US',
            'use_debug_toolbar' => true,
            'cookie_key' => 'fi9lbjo3xifaqvl9ef9fr5uiv96m9hwn0ski7vvbmkvgmohetrk1snniqpxwvtdo',
            'cookie_iv' => 'tzqmpx0zshpfb3tioxoiugwpx6apbuoh',
            'new_cookie_key' => 'def00000d428ee42395f12f07f4ab1721ad4a752ccc050534b069357e47324264ce99338e64d54e3a9d8706ba48ec18035072b41f77ad998e59e75d9815a73ddcb2f434b',
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQC3BXCEsLnO6eHT'."\n".'fOHwRrT050SEWcbloxz/rIT8Uoi+9j8XCF2Cb8u84WX3fTWFt9Mv6foG9Vu5I8xY'."\n".'BbSztRbJAI8fSRrPAeZAEY999+zR9aeoAiU30mCz7V4VgUZ4oSBONQg05zsA9xHj'."\n".'ONYuwiAqCokKfbgPBAeU3jy61IH8vFKF042Iswr0njQlACmJierJOMjQV0jw3c15'."\n".'FOtjDS7xfUeNw5qVPASShb0PCGczZVfvwqDsD6hrNOSo13uP6DinXgYex9VikyQn'."\n".'Nz0jmXWe1u5eZJpYP6F/klYsAKq/xrXy9vzLbBMArc4DpAkEs6dv52BbF3IrBhe1'."\n".'toMYr6RpAgMBAAECggEBAKW3GyZKDjO3uW4QyVMR8o89R+C+mUUb6AnoX5FH+eFO'."\n".'fdmRDXopV8RyIi1xBaFJzMK5jFX4m1CLhV6969w7v6HIC888FjYRdjXUsKRSc++4'."\n".'ClIpfyGIL187MdEu+GwJGIM3qXKdW+OH0n523BgCVbU7TNJe+uU9tM+qWjqgaAI5'."\n".'yLypJbAug1U6RrixV1xFyyR07ic5dk3YmusXmmpGp25qNmcGh8VEis/C4A8VQ5Sq'."\n".'ZWsVp/tCghsfEAkPrhadjI2GdxwEiZOHebGUmNNpj9mdVDw3qaa1M7MyqOc4tED0'."\n".'WNfiEpET0v+2FpHDg0D9ASKz3AXUpoQzspG3Lg5UdTECgYEA7NPi16SS0WXPxZjJ'."\n".'G4V6cXYzQJgrBmTS72doNOBw2JIEmlc7p493qCGHb145fUs7sieBCoxeRGvGRYZJ'."\n".'ewofmu0XRQAigGCNV95jYCiQ7Knzg1SRhfpo06EZ9acaANO6sk/w1xlRtBY7U4B/'."\n".'0KDa4PfcCB1WBeu14o3OWOq8X7sCgYEAxdZyZm+/TBepH574+6F4Gj+kayipNSRI'."\n".'rUlIDKEUvuzmApwq8Sjh9KRtfODyugdwrv2m2j1XfuTEC3zpMGHXB2Si/NECqmAe'."\n".'JEDloIOKA3swxV6SUz0tcEkNqZeeDPwBr+PcfyydH3LNon8GhHjCse9Z9Bgz2V+o'."\n".'4HR3ZQSBsCsCgYB870Zy9knRl4ElP3WQRDkU1AMzp1LDO7sfOpD5nBFL3rP46933'."\n".'hjLciluVP8LaOy8Ry89CTkyIkcZ19OKcuvlzVHH7H5gT21uVKCeKmbvibcGd3aYr'."\n".'ZK+aPRmhwvZvy0JpQMzP3HaCp1vCsD49RC5Tkc4MpdU0qGU6UA60T5jycwKBgFpZ'."\n".'p4FUw36Sx7AjP/5bLah/LC2sMiqM2YwaDYeHARx4wEqs24erbhX2CfKgIPoIb9Pb'."\n".'D5pXrV/MRiQg9bYc2MENmsnvAlKg9uMDqFr3983DMvDQUe8l31yKYGz1Sz8O0A5t'."\n".'98M0ssUr/vGZJXbWV8Q/VUt+yh8Z6twnFGfT+Q5lAoGAczcGMCzXqYK+mV/+Ra7H'."\n".'X9Ta4IkyNaUauT4h7iJM+ciKmhD4z3UEUu0CLaefdcYH69LdSAdRubVotXfhD0x8'."\n".'LdinPGJRRIqo+ZVHxnXnubkAyvgJz5HieMVnrDavhq60ZGCoc0XbDyrroz6arXkV'."\n".'0BV77gpl7/Q3qZNJDhHfAJs='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                1 => (\dirname(__DIR__, 4).'/modules/psgdpr/translations'),
                2 => (\dirname(__DIR__, 4).'/modules/ps_contactinfo/translations'),
                3 => (\dirname(__DIR__, 4).'/modules/ps_languageselector/translations'),
                4 => (\dirname(__DIR__, 4).'/modules/ps_currencyselector/translations'),
                5 => (\dirname(__DIR__, 4).'/modules/ps_customersignin/translations'),
                6 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                7 => (\dirname(__DIR__, 4).'/modules/ps_searchbar/translations'),
                8 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/ps_emailsubscription/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/mpm_blog/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/mpm_brands/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/mpm_contactform/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/mpm_customblock/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/mpm_customfeatured/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/mpm_documentation/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/mpm_footer/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/mpm_header/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/mpm_homeblocks/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/mpm_homefeatured/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/mpm_homepage/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/mpm_homeslider/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/mpm_scrolltop/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/mpm_social_buttons/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/mpm_socialsharebuttons/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/mpm_subcategories/translations'),
                67 => (\dirname(__DIR__, 4).'/modules/mpm_suppliers/translations'),
                68 => (\dirname(__DIR__, 4).'/modules/mpm_testimonials/translations'),
                69 => (\dirname(__DIR__, 4).'/modules/mpm_themeconfigurator/translations'),
                70 => (\dirname(__DIR__, 4).'/modules/mpm_topmenu/translations'),
                71 => (\dirname(__DIR__, 4).'/modules/mpm_viewproductlist/translations'),
            ],
            ...
            'kernel.secret' => 'jmo6hxttjfefbjeqocjal9ddxxu9grd9ufylerbha10zigajiila1c0wm543kyjz',
            ...
            'prestashop.commands_and_queries' => [
                ...
                8 => 'PrestaShop\\PrestaShop\\Core\\Domain\\ShowcaseCard\\Command\\CloseShowcaseCardCommand',
                9 => 'PrestaShop\\PrestaShop\\Core\\Domain\\ShowcaseCard\\Query\\GetShowcaseCardIsClosed',
                10 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Command\\SaveSqlRequestSettingsCommand',
                11 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Query\\GetSqlRequestSettings',
                12 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Theme\\Command\\ImportThemeCommand',
                13 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Theme\\Command\\EnableThemeCommand',
                14 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Theme\\Command\\DeleteThemeCommand',
                15 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Theme\\Command\\AdaptThemeToRTLLanguagesCommand',
                16 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Theme\\Command\\ResetThemeLayoutsCommand',
                17 => 'PrestaShop\\PrestaShop\\Core\\Domain\\MailTemplate\\Command\\GenerateThemeMailTemplatesCommand',
                18 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\DeleteAddressCommand',
                19 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\BulkDeleteAddressCommand',
                20 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\AddManufacturerAddressCommand',
                21 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\EditManufacturerAddressCommand',
                22 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Query\\GetManufacturerAddressForEditing',
                23 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Query\\GetRequiredFieldsForAddress',
                24 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\SetRequiredFieldsForAddressCommand',
                25 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\AddCustomerAddressCommand',
                26 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Query\\GetCustomerAddressForEditing',
                27 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\EditCustomerAddressCommand',
                28 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\EditOrderAddressCommand',
                29 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Address\\Command\\EditCartAddressCommand',
                30 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Command\\DeleteAttachmentCommand',
                31 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Command\\BulkDeleteAttachmentsCommand',
                32 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Query\\GetAttachment',
                33 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Query\\GetAttachmentForEditing',
                34 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Command\\EditAttachmentCommand',
                35 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Command\\AddAttachmentCommand',
                36 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Query\\GetAttachmentInformation',
                37 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Attachment\\Query\\SearchAttachment',
                38 => 'PrestaShop\\PrestaShop\\Core\\Domain\\AttributeGroup\\Attribute\\Command\\DeleteAttributeCommand',
                39 => 'PrestaShop\\PrestaShop\\Core\\Domain\\AttributeGroup\\Attribute\\Command\\BulkDeleteAttributeCommand',
                40 => 'PrestaShop\\PrestaShop\\Core\\Domain\\AttributeGroup\\Command\\DeleteAttributeGroupCommand',
                41 => 'PrestaShop\\PrestaShop\\Core\\Domain\\AttributeGroup\\Command\\BulkDeleteAttributeGroupCommand',
                42 => 'PrestaShop\\PrestaShop\\Core\\Domain\\AttributeGroup\\Query\\GetAttributeGroupList',
                43 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\AttributeGroup\\Query\\GetProductAttributeGroups',
                44 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Carrier\\Command\\ToggleCarrierStatusCommand',
                45 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Carrier\\Command\\ToggleCarrierIsFreeCommand',
                46 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Carrier\\Command\\DeleteCarrierCommand',
                47 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Carrier\\Command\\BulkDeleteCarrierCommand',
                48 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Carrier\\Command\\BulkToggleCarrierStatusCommand',
                49 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\CreateEmptyCustomerCartCommand',
                50 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateCartCurrencyCommand',
                51 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateCartLanguageCommand',
                52 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateCartAddressesCommand',
                53 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateCartDeliverySettingsCommand',
                54 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateProductQuantityInCartCommand',
                55 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateCartCarrierCommand',
                56 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\AddCartRuleToCartCommand',
                57 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\RemoveCartRuleFromCartCommand',
                58 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\RemoveProductFromCartCommand',
                59 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\UpdateProductPriceInCartCommand',
                60 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\SendCartToCustomerCommand',
                61 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Query\\GetCartForViewing',
                62 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Query\\GetLastEmptyCustomerCart',
                63 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Query\\GetCartForOrderCreation',
                64 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\AddCustomizationCommand',
                65 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Cart\\Command\\AddProductToCartCommand',
                66 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Command\\AddCartRuleCommand',
                67 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Query\\GetCartRuleForEditing',
                68 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Query\\SearchCartRules',
                69 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Command\\DeleteCartRuleCommand',
                70 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Command\\BulkDeleteCartRuleCommand',
                71 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Command\\ToggleCartRuleStatusCommand',
                72 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CartRule\\Command\\BulkToggleCartRuleStatusCommand',
                73 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CatalogPriceRule\\Command\\DeleteCatalogPriceRuleCommand',
                74 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CatalogPriceRule\\Command\\BulkDeleteCatalogPriceRuleCommand',
                75 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CatalogPriceRule\\Command\\AddCatalogPriceRuleCommand',
                76 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CatalogPriceRule\\Command\\EditCatalogPriceRuleCommand',
                77 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CatalogPriceRule\\Query\\GetCatalogPriceRuleForEditing',
                78 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CatalogPriceRule\\Query\\GetCatalogPriceRuleListForProduct',
                79 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\BulkUpdateCategoriesStatusCommand',
                80 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\BulkEnableCategoriesCommand',
                81 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\BulkDisableCategoriesCommand',
                82 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\SetCategoryIsEnabledCommand',
                83 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\DeleteCategoryCommand',
                84 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\BulkDeleteCategoriesCommand',
                85 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\AddCategoryCommand',
                86 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\AddRootCategoryCommand',
                87 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\EditRootCategoryCommand',
                88 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\EditCategoryCommand',
                89 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Query\\GetCategoryForEditing',
                90 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\DeleteCategoryCoverImageCommand',
                91 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\DeleteCategoryMenuThumbnailImageCommand',
                92 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Command\\UpdateCategoryPositionCommand',
                93 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Query\\GetCategoryIsEnabled',
                94 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Category\\Query\\GetCategoriesTree',
                95 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\BulkDisableCmsPageCommand',
                96 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\BulkEnableCmsPageCommand',
                97 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\ToggleCmsPageStatusCommand',
                98 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Query\\GetCmsCategoryIdForRedirection',
                99 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\DeleteCmsPageCommand',
                100 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\BulkDeleteCmsPageCommand',
                101 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\AddCmsPageCommand',
                102 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Command\\EditCmsPageCommand',
                103 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPage\\Query\\GetCmsPageForEditing',
                104 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\DeleteCmsPageCategoryCommand',
                105 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\ToggleCmsPageCategoryStatusCommand',
                106 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\BulkDeleteCmsPageCategoryCommand',
                107 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\BulkEnableCmsPageCategoryCommand',
                108 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\BulkDisableCmsPageCategoryCommand',
                109 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\AddCmsPageCategoryCommand',
                110 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Command\\EditCmsPageCategoryCommand',
                111 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Query\\GetCmsPageCategoriesForBreadcrumb',
                112 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Query\\GetCmsPageParentCategoryIdForRedirection',
                113 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Query\\GetCmsPageCategoryForEditing',
                114 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CmsPageCategory\\Query\\GetCmsPageCategoryNameForListing',
                115 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Configuration\\Command\\SwitchDebugModeCommand',
                116 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Contact\\Query\\GetContactForEditing',
                117 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Contact\\Command\\EditContactCommand',
                118 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Contact\\Command\\AddContactCommand',
                119 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Country\\Query\\GetCountryRequiredFields',
                120 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Country\\Command\\AddCountryCommand',
                121 => 'PrestaShop\\PrestaShop\\Core\\Domain\\CreditSlip\\Query\\GetCreditSlipIdsByDateRange',
                122 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\ToggleCurrencyStatusCommand',
                123 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\DeleteCurrencyCommand',
                124 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\AddCurrencyCommand',
                125 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\AddUnofficialCurrencyCommand',
                126 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\EditCurrencyCommand',
                127 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\EditUnofficialCurrencyCommand',
                128 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\RefreshExchangeRatesCommand',
                129 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\BulkToggleCurrenciesStatusCommand',
                130 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Command\\BulkDeleteCurrenciesCommand',
                131 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Query\\GetCurrencyForEditing',
                132 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Query\\GetCurrencyExchangeRate',
                133 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Currency\\Query\\GetReferenceCurrency',
                134 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\GetCustomerForViewing',
                135 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\SetPrivateNoteAboutCustomerCommand',
                136 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\TransformGuestToCustomerCommand',
                137 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\SetRequiredFieldsForCustomerCommand',
                138 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\GetRequiredFieldsForCustomer',
                139 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\AddCustomerCommand',
                140 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\GetCustomerForEditing',
                141 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\EditCustomerCommand',
                142 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\BulkEnableCustomerCommand',
                143 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\BulkDisableCustomerCommand',
                144 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\DeleteCustomerCommand',
                145 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Command\\BulkDeleteCustomerCommand',
                146 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\SearchCustomers',
                147 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\GetCustomerCarts',
                148 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\GetCustomerOrders',
                149 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Customer\\Query\\GetCustomerForAddressCreation',
                150 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Command\\ToggleEmployeeStatusCommand',
                151 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Command\\BulkUpdateEmployeeStatusCommand',
                152 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Command\\DeleteEmployeeCommand',
                153 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Command\\BulkDeleteEmployeeCommand',
                154 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Query\\GetEmployeeForEditing',
                155 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Command\\AddEmployeeCommand',
                156 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Command\\EditEmployeeCommand',
                157 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Employee\\Query\\GetEmployeeEmailById',
                158 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Feature\\Command\\AddFeatureCommand',
                159 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Feature\\Command\\EditFeatureCommand',
                160 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Feature\\Query\\GetFeatureForEditing',
                161 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Feature\\Command\\AddFeatureValueCommand',
                162 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Feature\\Command\\EditFeatureValueCommand',
                163 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Feature\\Query\\GetFeatureValueForEditing',
                164 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Hook\\Command\\UpdateHookStatusCommand',
                165 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Hook\\Query\\GetHookStatus',
                166 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Command\\AddLanguageCommand',
                167 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Command\\EditLanguageCommand',
                168 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Query\\GetLanguageForEditing',
                169 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Command\\ToggleLanguageStatusCommand',
                170 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Command\\BulkToggleLanguagesStatusCommand',
                171 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Command\\BulkDeleteLanguagesCommand',
                172 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Language\\Command\\DeleteLanguageCommand',
                173 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\ToggleManufacturerStatusCommand',
                174 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\BulkToggleManufacturerStatusCommand',
                175 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\DeleteManufacturerCommand',
                176 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\DeleteManufacturerLogoImageCommand',
                177 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\BulkDeleteManufacturerCommand',
                178 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Query\\GetManufacturerForEditing',
                179 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\EditManufacturerCommand',
                180 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Command\\AddManufacturerCommand',
                181 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Manufacturer\\Query\\GetManufacturerForViewing',
                182 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Meta\\Command\\AddMetaCommand',
                183 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Meta\\Command\\EditMetaCommand',
                184 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Meta\\Query\\GetMetaForEditing',
                185 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Meta\\Query\\GetPagesForLayoutCustomization',
                186 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Module\\Command\\BulkToggleModuleStatusCommand',
                187 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Notification\\Command\\UpdateEmployeeNotificationLastElementCommand',
                188 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Notification\\Query\\GetNotificationLastElements',
                189 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\DuplicateOrderCartCommand',
                190 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\AddOrderFromBackOfficeCommand',
                191 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Product\\Command\\AddProductToOrderCommand',
                192 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\UpdateOrderStatusCommand',
                193 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Product\\Command\\UpdateProductInOrderCommand',
                194 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\ChangeOrderDeliveryAddressCommand',
                195 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\ChangeOrderInvoiceAddressCommand',
                196 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\ChangeOrderCurrencyCommand',
                197 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Payment\\Command\\AddPaymentCommand',
                198 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Invoice\\Command\\GenerateInvoiceCommand',
                199 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\UpdateOrderShippingDetailsCommand',
                200 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\DeleteCartRuleFromOrderCommand',
                201 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\AddCartRuleToOrderCommand',
                202 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Invoice\\Command\\UpdateInvoiceNoteCommand',
                203 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\IssuePartialRefundCommand',
                204 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\IssueStandardRefundCommand',
                205 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\IssueReturnProductCommand',
                206 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Product\\Command\\DeleteProductFromOrderCommand',
                207 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\BulkChangeOrderStatusCommand',
                208 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Query\\GetOrderForViewing',
                209 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Query\\GetOrderProductsForViewing',
                210 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\ResendOrderEmailCommand',
                211 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Query\\GetOrderPreview',
                212 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\SendProcessOrderEmailCommand',
                213 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\CancelOrderProductCommand',
                214 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Order\\Command\\SetInternalOrderNoteCommand',
                215 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderMessage\\Command\\AddOrderMessageCommand',
                216 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderMessage\\Command\\EditOrderMessageCommand',
                217 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderMessage\\Query\\GetOrderMessageForEditing',
                218 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderMessage\\Command\\DeleteOrderMessageCommand',
                219 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderMessage\\Command\\BulkDeleteOrderMessageCommand',
                220 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturn\\Query\\GetOrderReturnForEditing',
                221 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturn\\Command\\UpdateOrderReturnStateCommand',
                222 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturnState\\Command\\AddOrderReturnStateCommand',
                223 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturnState\\Query\\GetOrderReturnStateForEditing',
                224 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturnState\\Command\\EditOrderReturnStateCommand',
                225 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturnState\\Command\\DeleteOrderReturnStateCommand',
                226 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderReturnState\\Command\\BulkDeleteOrderReturnStateCommand',
                227 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderState\\Command\\AddOrderStateCommand',
                228 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderState\\Query\\GetOrderStateForEditing',
                229 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderState\\Command\\EditOrderStateCommand',
                230 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderState\\Command\\DeleteOrderStateCommand',
                231 => 'PrestaShop\\PrestaShop\\Core\\Domain\\OrderState\\Command\\BulkDeleteOrderStateCommand',
                232 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\GenerateProductCombinationsCommand',
                233 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\UpdateCombinationCommand',
                234 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\UpdateCombinationStockAvailableCommand',
                235 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Query\\GetCombinationForEditing',
                236 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Query\\GetEditableCombinationsList',
                237 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Query\\SearchCombinationsForAssociation',
                238 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\UpdateCombinationSuppliersCommand',
                239 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Query\\GetCombinationSuppliers',
                240 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\SetCombinationImagesCommand',
                241 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\RemoveAllCombinationImagesCommand',
                242 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\DeleteCombinationCommand',
                243 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Command\\BulkDeleteCombinationCommand',
                244 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Query\\SearchProductCombinations',
                245 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Combination\\Query\\GetCombinationIds',
                246 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Customization\\Query\\GetProductCustomizationFields',
                247 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Customization\\Command\\SetProductCustomizationFieldsCommand',
                248 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Customization\\Command\\RemoveAllCustomizationFieldsFromProductCommand',
                249 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\FeatureValue\\Command\\SetProductFeatureValuesCommand',
                250 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\FeatureValue\\Command\\RemoveAllFeatureValuesFromProductCommand',
                251 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\FeatureValue\\Query\\GetProductFeatureValues',
                252 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Command\\AddProductImageCommand',
                253 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Command\\UpdateProductImageCommand',
                254 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Command\\DeleteProductImageCommand',
                255 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Command\\SetProductImagesForAllShopCommand',
                256 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Query\\GetProductImages',
                257 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Query\\GetShopProductImages',
                258 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Image\\Query\\GetProductImage',
                259 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Pack\\Command\\SetPackProductsCommand',
                260 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Pack\\Command\\RemoveAllProductsFromPackCommand',
                261 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Pack\\Query\\GetPackedProducts',
                262 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Query\\GetSpecificPriceList',
                263 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Query\\GetSpecificPriceForEditing',
                264 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Command\\AddSpecificPriceCommand',
                265 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Command\\EditSpecificPriceCommand',
                266 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Command\\DeleteSpecificPriceCommand',
                267 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Command\\SetSpecificPricePriorityForProductCommand',
                268 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\SpecificPrice\\Command\\RemoveSpecificPricePriorityForProductCommand',
                269 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Stock\\Query\\GetProductStockMovements',
                270 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Stock\\Query\\GetCombinationStockMovements',
                271 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\VirtualProductFile\\Command\\AddVirtualProductFileCommand',
                272 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\VirtualProductFile\\Command\\UpdateVirtualProductFileCommand',
                273 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\VirtualProductFile\\Command\\DeleteVirtualProductFileCommand',
                274 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\AssignProductToCategoryCommand',
                275 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\UpdateProductStatusCommand',
                276 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Query\\SearchProducts',
                277 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Query\\SearchProductsForAssociation',
                278 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Query\\GetProductIsEnabled',
                279 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Query\\GetProductForEditing',
                280 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\AddProductCommand',
                281 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\SetProductTagsCommand',
                282 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\UpdateProductsPositionsCommand',
                283 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\RemoveAllProductTagsCommand',
                284 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\SetAssociatedProductCategoriesCommand',
                285 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\RemoveAllAssociatedProductCategoriesCommand',
                286 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\SetCarriersCommand',
                287 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Supplier\\Query\\GetProductSupplierOptions',
                288 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Supplier\\Query\\GetAssociatedSuppliers',
                289 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Supplier\\Command\\SetSuppliersCommand',
                290 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Supplier\\Command\\SetProductDefaultSupplierCommand',
                291 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Supplier\\Command\\UpdateProductSuppliersCommand',
                292 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Supplier\\Command\\RemoveAllAssociatedProductSuppliersCommand',
                293 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\DeleteProductCommand',
                294 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\BulkDeleteProductCommand',
                295 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\BulkDuplicateProductCommand',
                296 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\BulkUpdateProductStatusCommand',
                297 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Attachment\\Command\\SetAssociatedProductAttachmentsCommand',
                298 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Attachment\\Command\\RemoveAllAssociatedProductAttachmentsCommand',
                299 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\SetRelatedProductsCommand',
                300 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Query\\GetRelatedProducts',
                301 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\RemoveAllRelatedProductsCommand',
                302 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\DuplicateProductCommand',
                303 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\UpdateProductTypeCommand',
                304 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Shop\\Command\\SetProductShopsCommand',
                305 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Command\\UpdateProductCommand',
                306 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Product\\Stock\\Command\\UpdateProductStockAvailableCommand',
                307 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Command\\DeleteProfileCommand',
                308 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Command\\BulkDeleteProfileCommand',
                309 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Command\\AddProfileCommand',
                310 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Command\\EditProfileCommand',
                311 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Query\\GetProfileForEditing',
                312 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Permission\\Command\\UpdateTabPermissionsCommand',
                313 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Permission\\Query\\GetPermissionsForConfiguration',
                314 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Profile\\Permission\\Command\\UpdateModulePermissionsCommand',
                315 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SearchEngine\\Command\\AddSearchEngineCommand',
                316 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SearchEngine\\Command\\BulkDeleteSearchEngineCommand',
                317 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SearchEngine\\Command\\DeleteSearchEngineCommand',
                318 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SearchEngine\\Command\\EditSearchEngineCommand',
                319 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SearchEngine\\Query\\GetSearchEngineForEditing',
                320 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Security\\Command\\DeleteCustomerSessionCommand',
                321 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Security\\Command\\ClearOutdatedCustomerSessionCommand',
                322 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Security\\Command\\DeleteEmployeeSessionCommand',
                323 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Security\\Command\\ClearOutdatedEmployeeSessionCommand',
                324 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Security\\Command\\BulkDeleteEmployeeSessionsCommand',
                325 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Security\\Command\\BulkDeleteCustomerSessionsCommand',
                326 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Shop\\Command\\UploadLogosCommand',
                327 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Shop\\Query\\GetLogosPaths',
                328 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Shop\\Query\\SearchShops',
                329 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SpecificPrice\\Command\\AddSpecificPriceCommand',
                330 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SpecificPrice\\Command\\DeleteSpecificPriceByCartProductCommand',
                331 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Command\\AddSqlRequestCommand',
                332 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Command\\EditSqlRequestCommand',
                333 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Command\\DeleteSqlRequestCommand',
                334 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Command\\BulkDeleteSqlRequestCommand',
                335 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Query\\GetSqlRequestForEditing',
                336 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Query\\GetSqlRequestExecutionResult',
                337 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Query\\GetDatabaseTablesList',
                338 => 'PrestaShop\\PrestaShop\\Core\\Domain\\SqlManagement\\Query\\GetDatabaseTableFieldsList',
                339 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Command\\AddStateCommand',
                340 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Command\\EditStateCommand',
                341 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Command\\ToggleStateStatusCommand',
                342 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Query\\GetStateForEditing',
                343 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Command\\DeleteStateCommand',
                344 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Command\\BulkDeleteStateCommand',
                345 => 'PrestaShop\\PrestaShop\\Core\\Domain\\State\\Command\\BulkToggleStateStatusCommand',
                346 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Store\\Query\\GetStoreForEditing',
                347 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Store\\Command\\ToggleStoreStatusCommand',
                348 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Store\\Command\\BulkUpdateStoreStatusCommand',
                349 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Store\\Command\\DeleteStoreCommand',
                350 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Store\\Command\\BulkDeleteStoreCommand',
                351 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\ToggleSupplierStatusCommand',
                352 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\DeleteSupplierCommand',
                353 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\DeleteSupplierLogoImageCommand',
                354 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\BulkDeleteSupplierCommand',
                355 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\BulkDisableSupplierCommand',
                356 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\BulkEnableSupplierCommand',
                357 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Query\\GetSupplierForViewing',
                358 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\AddSupplierCommand',
                359 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Query\\GetSupplierForEditing',
                360 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Supplier\\Command\\EditSupplierCommand',
                361 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tab\\Command\\UpdateTabStatusByClassNameCommand',
                362 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Command\\DeleteTaxCommand',
                363 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Command\\ToggleTaxStatusCommand',
                364 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Command\\BulkToggleTaxStatusCommand',
                365 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Command\\BulkDeleteTaxCommand',
                366 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Query\\GetTaxForEditing',
                367 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Command\\EditTaxCommand',
                368 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Tax\\Command\\AddTaxCommand',
                369 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Command\\AddTaxRulesGroupCommand',
                370 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Command\\EditTaxRulesGroupCommand',
                371 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Command\\DeleteTaxRulesGroupCommand',
                372 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Command\\BulkDeleteTaxRulesGroupCommand',
                373 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Command\\BulkSetTaxRulesGroupStatusCommand',
                374 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Query\\GetTaxRulesGroupForEditing',
                375 => 'PrestaShop\\PrestaShop\\Core\\Domain\\TaxRulesGroup\\Command\\SetTaxRulesGroupStatusCommand',
                376 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Title\\Command\\DeleteTitleCommand',
                377 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Title\\Command\\BulkDeleteTitleCommand',
                378 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Webservice\\Query\\GetWebserviceKeyForEditing',
                379 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Webservice\\Command\\AddWebserviceKeyCommand',
                380 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Webservice\\Command\\EditWebserviceKeyCommand',
                381 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Command\\AddZoneCommand',
                382 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Command\\ToggleZoneStatusCommand',
                383 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Command\\EditZoneCommand',
                384 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Query\\GetZoneForEditing',
                385 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Command\\DeleteZoneCommand',
                386 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Command\\BulkDeleteZoneCommand',
                387 => 'PrestaShop\\PrestaShop\\Core\\Domain\\Zone\\Command\\BulkToggleZoneStatusCommand',
            ],
            ...
            'prestashop.core.grid.definition.service_ids' => [
                ...
                47 => 'prestashop.core.grid.definition.factory.product.shops',
                48 => 'prestashop.core.grid.definition.factory.product_light',
                49 => 'prestashop.core.grid.definition.factory.security.session.employee',
                50 => 'prestashop.core.grid.definition.factory.security.session.customer',
                51 => 'prestashop.core.grid.definition.factory.state',
                52 => 'prestashop.core.grid.definition.factory.title',
                53 => 'prestashop.core.grid.definition.factory.customer_thread',
            ],
            'prestashop.core.form.identifiable_object.form_types' => [
                ...
                19 => 'PrestaShopBundle\\Form\\Admin\\Sell\\CustomerService\\MerchandiseReturn\\OrderReturnType',
                20 => 'PrestaShopBundle\\Form\\Admin\\Sell\\CatalogPriceRule\\CatalogPriceRuleType',
                21 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Attachment\\AttachmentType',
                22 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Order\\CancelProductType',
                23 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Address\\CustomerAddressType',
                24 => 'PrestaShopBundle\\Form\\Admin\\Configure\\ShopParameters\\OrderStates\\OrderStateType',
                25 => 'PrestaShopBundle\\Form\\Admin\\Configure\\ShopParameters\\OrderReturnStates\\OrderReturnStateType',
                26 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\CreateProductFormType',
                27 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\EditProductFormType',
                28 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\ProductShopsType',
                29 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\CombinationFormType',
                30 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\BulkCombinationType',
                31 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\CombinationListType',
                32 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Image\\ProductImageType',
                33 => 'PrestaShopBundle\\Form\\Admin\\Improve\\International\\Locations\\ZoneType',
                34 => 'PrestaShopBundle\\Form\\Admin\\Improve\\International\\Locations\\CountryType',
                35 => 'PrestaShopBundle\\Form\\Admin\\Configure\\ShopParameters\\SearchEngines\\SearchEngineType',
                36 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Category\\CategoryTreeSelectorType',
                37 => 'PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Pricing\\SpecificPriceType',
                38 => 'PrestaShopBundle\\Form\\Admin\\Improve\\International\\Locations\\StateType',
                39 => 'PrestaShopBundle\\Form\\Admin\\Improve\\International\\Tax\\TaxRulesGroupType',
            ],
            'console.command.ids' => [
