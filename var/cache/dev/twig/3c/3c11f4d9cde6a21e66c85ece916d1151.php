...
class __TwigTemplate_0e1ec01278b0e8f7495ed56bd2704590 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        echo (((twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 16, $this->source); })()), "requestCount", [], "any", false, false, false, 16) == 0)) ? ("disabled") : (""));
        echo "\">
    <span class=\"icon\">";
        // line 17
        echo twig_include($this->env, $context, "@WebProfiler/Icon/http-client.svg");
...
";
    ...
    ";
        // line 29
        if ((twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 29, $this->source); })()), "requestCount", [], "any", false, false, false, 29) == 0)) {
            // line 30
    ...
    ";
        ...
        <div class=\"sf-tabs\">
            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                // line 47
                echo "                <div class=\"tab ";
                echo (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 47)) == 0)) ? ("disabled") : (""));
                echo "\">
                    <h3 class=\"tab-title\">";
                // line 48
                ...
                echo "</span></h3>
                    <div class=\"tab-content\">
                        ";
                // line 50
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 50)) == 0)) {
                    // line 51
                    echo "                            <div class=\"empty\">
                        ...
                        echo "                                        </th>
                                    ...
                                    <tr>
                                        <th>
                                            ";
                        // line 74
                        if ((twig_get_attribute($this->env, $this->source, $context["trace"], "http_code", [], "any", false, false, false, 74) >= 500)) {
                            // line 75
                            echo "                                                ";
                            $context["responseStatus"] = "error";
                            // line 76
                            echo "                                            ";
                        } elseif ((twig_get_attribute($this->env, $this->source, $context["trace"], "http_code", [], "any", false, false, false, 76) >= 400)) {
                            // line 77
                            echo "                                                ";
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "/home/vol15_8/infinityfree.com/if0_36915431/htdocs/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/http_client.html.twig");
    }
}
