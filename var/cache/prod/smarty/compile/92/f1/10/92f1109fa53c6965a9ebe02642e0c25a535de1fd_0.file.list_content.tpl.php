...
/* Smarty version 4.3.4, created on 2024-07-18 20:32:00
  from '/home/vol15_8/infinityfree.com/if0_36915431/htdocs/admin45/themes/default/template/helpers/list/list_content.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_6699b400a60244_42532898',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '92f1109fa53c6965a9ebe02642e0c25a535de1fd' => 
    array (
      0 => '/home/vol15_8/infinityfree.com/if0_36915431/htdocs/admin45/themes/default/template/helpers/list/list_content.tpl',
      1 => 1716302594,
      2 => 'file',
    ),
  ),
...
function content_6699b400a60244_42532898 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/home/vol15_8/infinityfree.com/if0_36915431/htdocs/vendor/smarty/smarty/libs/plugins/function.counter.php','function'=>'smarty_function_counter',),1=>array('file'=>'/home/vol15_8/infinityfree.com/if0_36915431/htdocs/vendor/smarty/smarty/libs/plugins/modifier.count.php','function'=>'smarty_modifier_count',),));
...
$__foreach_tr_37_saved = $_smarty_tpl->tpl_vars['tr'];
?>
...
if ((isset($_smarty_tpl->tpl_vars['checked_boxes']->value)) && is_array($_smarty_tpl->tpl_vars['checked_boxes']->value) && in_array($_prefixVariable4,$_smarty_tpl->tpl_vars['checked_boxes']->value)) {?> checked="checked"<?php }?> class="noborder" />
				<?php }?>
			</td>
		<?php }?>
		<?php
...
?>
			<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_20996444626699b4009d9b05_78550065', "open_td");
?>

			<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_6580820996699b4009f0847_07554938', "td_content");
?>

			<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_13885266226699b400a49839_43965485', "close_td");
?>
...
?>
				<?php if ((isset($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['action']->value]))) {?>
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['action']->value == 'delete' && smarty_modifier_count($_smarty_tpl->tpl_vars['actions']->value) > 2) {?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['compiled_actions']->value) > 0) {?>
				<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['compiled_actions']->value) > 1) {?><div class="btn-group-action"><?php }?>
				<div class="btn-group pull-right">
					<?php echo $_smarty_tpl->tpl_vars['compiled_actions']->value[0];?>

					<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['compiled_actions']->value) > 1) {?>
...
?>
							<?php if ($_smarty_tpl->tpl_vars['key']->value != 0) {?>
							<li<?php if ($_smarty_tpl->tpl_vars['action']->value == 'divider' && smarty_modifier_count($_smarty_tpl->tpl_vars['compiled_actions']->value) > 3) {?> class="divider"<?php }?>>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
				...
				<?php if (smarty_modifier_count($_smarty_tpl->tpl_vars['compiled_actions']->value) > 1) {?></div><?php }?>
			<?php }?>
		</td>
	<?php }?>
	</tr>
<?php
$_smarty_tpl->tpl_vars['tr'] = $__foreach_tr_37_saved;
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
} else { ?>
	<tr>
...
<?php }
/* {block "open_td"} */
class Block_20996444626699b4009d9b05_78550065 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'open_td' => 
  array (
    0 => 'Block_20996444626699b4009d9b05_78550065',
  ),
);
...
if ((isset($_smarty_tpl->tpl_vars['key']->value))) {?> column-<?php echo mb_strtolower((string) $_smarty_tpl->tpl_vars['key']->value, 'UTF-8');
}
...
if ((isset($_smarty_tpl->tpl_vars['params']->value['align']))) {?> <?php echo $_smarty_tpl->tpl_vars['params']->value['align'];
            ...
            <?php if ((isset($_smarty_tpl->tpl_vars['tr']->value['link']))) {?>
              onclick="document.location = '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'addslashes' ][ 0 ], array( $_smarty_tpl->tpl_vars['tr']->value['link'] )),'html','UTF-8' ));?>
'">
            <?php } else { ?>
              onclick="document.location = '<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'addslashes' ][ 0 ], array( $_smarty_tpl->tpl_vars['current_index']->value )),'html','UTF-8' ));?>
...
if ($_smarty_tpl->tpl_vars['page']->value > 1) {?>&amp;page=<?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['page']->value ));
...
/* {/block "open_td"} */
/* {block "default_field"} */
class Block_1714476566699b400a3a5d0_91826446 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
--<?php
...
/* {/block "default_field"} */
/* {block "td_content"} */
class Block_6580820996699b4009f0847_07554938 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'td_content' => 
  array (
    0 => 'Block_6580820996699b4009f0847_07554938',
  ),
  'default_field' => 
  array (
    0 => 'Block_1714476566699b400a3a5d0_91826446',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
"><?php echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'truncate' ][ 0 ], array( $_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value],$_smarty_tpl->tpl_vars['params']->value['maxlength'],'...' )),'html','UTF-8' ));?>
				...
				<?php } else { ?>
					<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_1714476566699b400a3a5d0_91826446', "default_field", $this->tplIndex);
?>
...
/* {/block "td_content"} */
/* {block "close_td"} */
class Block_13885266226699b400a49839_43965485 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'close_td' => 
  array (
    0 => 'Block_13885266226699b400a49839_43965485',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
